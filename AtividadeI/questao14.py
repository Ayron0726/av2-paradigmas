...
(peso de peixes) e calcule o excesso. Gravar na variável excesso 
a quantidade de quilos além do limite e na variável multa o 
...
if peso > 50.0: 
    excesso = peso - 50 
    multa = (peso - 50.0) * 4.00 
    print(f"\nVocê excedeu {excesso:.2f}Kg") 
