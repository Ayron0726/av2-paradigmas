'''16. Faça um programa para uma loja de tintas. O programa 
deverá pedir o tamanho em metros quadrados da área a ser 
pintada. Considere que a cobertura da tinta é de 1 litro para 
...
area = float(input("Área em metros quadrados a ser pintada:")) 
litros = area / 3 
latas = int(litros / 18) 
if (litros % 18 != 0): 
    latas += 1 
    print("Latas necessárias: ", latas) 
    print("Valor: R$", latas * 80)